...
const LinkSocialMedia: React.FC = () => {
    ...
    const getUsername = async () => {
        try {
            ...
            const response = await fetch(
                `${import.meta.env.VITE_BACKEND_API_URL}/api/profile-data`,
                {
                    method: "GET",
                    headers: {
    ...
    const fetchSocialMediaLinks = async () => {
        try {
            const token = await getToken();
            const response = await fetch(`${import.meta.env.VITE_BACKEND_API_URL}/api/connected_social_media`, {
                method: "GET",
                headers: {
                    Authorization: `Bearer ${token}`,
                    "Content-Type": "application/json",
    ...
    const handleFormSubmit = async () => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_BACKEND_API_URL}/api/products/update`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${token}`,
                    "Content-Type": "application/json",
    ...
    const fetchPreviousListings = async () => {
        try {
            ...
            const response = await fetch(
                `${import.meta.env.VITE_BACKEND_API_URL}/api/products/previous`,
                {
                    method: "GET",
                    headers: {
                        Authorization: `Bearer ${token}`,
    ...
    const toggleApprovalStatus = async (product: ProductData) => {
        try {
            ...
            const response = await fetch(
                `${import.meta.env.VITE_BACKEND_API_URL}/api/products/update`,
                {
                    method: "POST",
                    headers: {
    ...
    const fetchInstagramPosts = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `${import.meta.env.VITE_BACKEND_API_URL}/api/insta/`,
                {
                    method: "POST",
                    headers: {
                        Authorization: `Bearer ${token}`,
    ...
    const ConvertVideoInstatoProjectListing = async (post_link: string | null, video_url: string, description: string) => {
        ...
        try {
            ...
            const response = await fetch(
                `${import.meta.env.VITE_BACKEND_API_URL}/api/convert/video-to-images`,
                {
                    method: "POST",
                    headers: {
                        Authorization: `Bearer ${token}`,
    ...
    const fetchFacebookPosts = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `${import.meta.env.VITE_BACKEND_API_URL}/api/facebook/`,
                {
                    method: "POST",
                    headers: {
                        Authorization: `Bearer ${token}`,
    ...
    // Convert to Product Listing (Social2Amazon)
    const convertToProductListing = async (post_link: string | null, image_url: string[], description: string) => {
        ...
        try {
            ...
            const response = await fetch(
                `${import.meta.env.VITE_BACKEND_API_URL}/api/convert/social2amazon`,
                {
                    method: "POST",
                    headers: {
                        Authorization: `Bearer ${token}`,
                                        ...
                                        <div className="main-content-wrap">
                                            ...
                                            <div className="wg-box mb-30">
                                                ...
                                                <div className="mb-4 flex flex-col items-center">
                                                    ...
                                                    />
                                                    <button
                                                        className={`btn btn-primary w-full ${loadingPosts ? "opacity-50 cursor-not-allowed" : ""}`}
                                            ...
                                            <div className="wg-box mb-30">
                                                ...
                                                <div className="mb-4 flex flex-col items-center">
                                                    ...
                                                    />
                                                    <button
                                                        className={`btn btn-primary w-full ${loadingFBPosts ? "opacity-50 cursor-not-allowed" : ""}`}
