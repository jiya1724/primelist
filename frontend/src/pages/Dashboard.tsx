...
const Dashboard: React.FC = () => {
    ...
    const fetchDashboardStats = async () => {
        try {
            const token = await getToken();
            const response = await fetch(`${import.meta.env.VITE_BACKEND_API_URL}/api/dashboard-stats`, {
                method: "GET",
                headers: {
                    Authorization: `Bearer ${token}`,
                    "Content-Type": "application/json",
                        ...
                        <div className="section-menu-left dark-sidebar">
                            <div className="box-logo">
                                <Link to="#" id="site-logo-inner">
                                    <img className="logo" src="images/logo/logo.png" alt="" height="50px" width="50px" />
                                </Link>
